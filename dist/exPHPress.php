...
define('REQUEST_URL', explode('#', explode('?', $_SERVER['REQUEST_URI'])[0])[0]);
define('ROUTE', array_slice(array_filter(explode('/', REQUEST_URL)), count(array_filter(explode('/', $_SERVER['PHP_SELF']))) - 1));
